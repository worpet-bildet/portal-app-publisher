...
{#if open}
  ...
  />
  <div
    class="fixed top-0 left-0 h-screen w-screen flex justify-center items-center z-30 p-16"
    on:click={() => (open = false)}
  >
    <div
      class="inline justify-center items-center min-w-full md:min-w-[45rem] max-w-screen-lg max-h-screen md:max-h-[40rem] overflow-y-auto bg-offwhite opacity-100 rounded-2xl"
